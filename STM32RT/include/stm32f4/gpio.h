...
#define GPIOE_MODER		_IOREG(GPIO_BASE(3), 0x00)
#define GPIOE_OTYPER	_IOREG(GPIO_BASE(3), 0x04)
#define GPIOE_OSPEEDR	_IOREG(GPIO_BASE(3), 0x08)
#define GPIOE_OSPEEDR	_IOREG(GPIO_BASE(3), 0x08)
#define GPIOE_PUPDR		_IOREG(GPIO_BASE(3), 0x0c)
#define GPIOE_IDR		_IOREG(GPIO_BASE(3), 0x10)
#define GPIOE_ODR		_IOREG(GPIO_BASE(3), 0x14)
#define GPIOE_BSRR		_IOREG(GPIO_BASE(3), 0x18)
#define GPIOE_LCKR		_IOREG(GPIO_BASE(3), 0x1c)
#define GPIOE_AFRL		_IOREG(GPIO_BASE(3), 0x20)
#define GPIOE_AFRH		_IOREG(GPIO_BASE(3), 0x24)
