...
#define USART6_IOREG(o)	_IOREG(USART6_BASE, o)

#define USART2_BASE 0x40004400U
#define USART2_IOREG(o)	_IOREG(USART2_BASE, o)

// USART 1
#define USART1_SR USART1_IOREG(0x00)
#define USART1_DR USART1_IOREG(0x04)
#define USART1_BRR USART1_IOREG(0x08)
#define USART1_CR1 USART1_IOREG(0x0C)
#define USART1_CR2 USART1_IOREG(0x10)
#define USART1_CR3 USART1_IOREG(0x14)
#define USART1_GTPR USART1_IOREG(0x18)

// USART6
#define USART6_SR USART6_IOREG(0x00)
#define USART6_DR USART6_IOREG(0x04)
#define USART6_BRR USART6_IOREG(0x08)
#define USART6_CR1 USART6_IOREG(0x0C)
#define USART6_CR2 USART6_IOREG(0x10)
#define USART6_CR3 USART6_IOREG(0x14)
#define USART6_GTPR USART6_IOREG(0x18)

// USART2
#define USART2_SR USART2_IOREG(0x00)
#define USART2_DR USART2_IOREG(0x04)
#define USART2_BRR USART2_IOREG(0x08)
#define USART2_CR1 USART2_IOREG(0x0C)
#define USART2_CR2 USART2_IOREG(0x10)
#define USART2_CR3 USART2_IOREG(0x14)
#define USART2_GTPR USART6_IOREG(0x18)
